...
with_node \
  ...
  --target "/Users/shuvo/code/practice/podcas/ios/Pods/Target Support Files/Pods-app/ExpoModulesProvider.swift" \
  --entitlement "/Users/shuvo/code/practice/podcas/ios/app/app.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-audio" "expo-av" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-system-ui"
